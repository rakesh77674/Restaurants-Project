...
<html lang="en">
  ...
  <div class="container-scroller">
   ...
   <div style = "width:100%; text-align:center; padding:20px 40px;background:gray;">
                <form action = "{{url('/foodchef')}}" method="post" enctype = "multipart/form-data">
                @csrf
                <fieldset>
                     <div>
                     <label style = "font-size: 24px; padding:20px 5px;">Name: </label>
                     <input style = "color: black;padding:10px 54px; border-radius: 10px;widh:50%;" type = "text"  name = "name" placeholder = "write a Name" required>
                     </div>
                     <div>
                     <label style = "font-size: 24px; padding:20px 5px;">Speciality: </label>
                     <input style = "color: blue;padding:10px 54px; border-radius: 10px;widh:50%;" type = "text"  name = "speciality" placeholder = "Speciality" required>
                     </div>
                     <div style="width: 110%;">
                    ...
                    <table bgcolor="grey" style="background-color: #191c24; margin-top: 10px; width: 95%;" border="3px"  width = "100%">
                        ...
                        <td ><img height = "150" width = "150" margin = "12"src = "/chefimage/{{$data->image}}"></td>
                    ...
                    <div>
                        ...
                        justify-content: center;text-decoration: none;margin: 12px;" href= "{{url('/chefdelete', $data->id)}}">Delete</a></td>
                        ...
                        justify-content: center;text-decoration: none;" href= "{{url('/chefview', $data->id)}}">update</a></td>
                    <div>
                        </tr>
                        @endforeach
                    </table>
